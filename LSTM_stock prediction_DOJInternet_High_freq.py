...
class LSTM_stock_predict:
    ...
    def Model_train(self, data_path, freq):
        self.df = pd.read_csv(data_path + 'DJINET_{}min_sample.csv'.format(freq))
        ...
        self.model.save('LSTM_stock prediciton_DOJInternet_High_freq.h5')
    ...
    def Model_load(self, data_path, data):
        ...
        self.model = load_model(data_path+'LSTM_stock prediciton_DOJInternet_High_freq.h5')
...
if __name__ == '__main__':
    ...
    predictor.Model_train(data_path, freq=30) #freq option: 1, 5 and 30